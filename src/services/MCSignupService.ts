...
export class MCSignupService {
    ...
    private moderatorGetPicksUrl = DiscordAuthenticationService.API_URL + "/moderator/getSignups";
    ...
    getAllSignups$(): Observable<Signup[]> {
        return this.httpService.makeAuthenticatedRequest$(this.moderatorGetPicksUrl, this.discordAuthService.getToken()!).pipe(
            map((result: any) => {
